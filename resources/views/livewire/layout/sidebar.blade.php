    ...
    <div class="flex w-80 flex-col glass border-r border-white/20 shadow-xl">
        ...
        <div class="flex items-center justify-center h-20 px-6 border-b border-white/10">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">ZIMA ESB</h1>
        ...
        <div class="flex-1 px-6 py-8">
            <nav class="space-y-3">
                ...
                <div class="mb-8">
                    ...
                    <!-- Dashboard -->
                    <a wire:click="setPage('dashboard')" class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'dashboard' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
                ...
                <div class="mb-8">
                    ...
                    <!-- Clients -->
                    <a wire:click="setPage('clients')" class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'clients' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
                    ...
                    <!-- Aggregators -->
                    <a wire:click="setPage('aggregators')" class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'aggregators' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
                    ...
                    <!-- Services -->
                    <a wire:click="setPage('services')" class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'services' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
                    ...
                    <!-- Service Mapping -->
                    <a wire:click="setPage('services-mapping')" class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'services-mapping' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
                    ...
                    <!-- Transactions -->
                    <a wire:click="setPage('transactions')" class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'transactions' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
                ...
                <div class="mb-8">
                    ...
                    <!-- Reports -->
                    <a wire:click="setPage('reports')" class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'reports' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
                ...
                <div class="mb-8">
                    ...
                    <!-- Security Settings -->
                    <a wire:click="setPage('security-settings')" class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'security-settings' ? 'bg-gradient-to-r from-red-600 to-pink-600 text-white shadow-lg shadow-red-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
                ...
                <div>
                    ...
                    <a 
                     ...
                     class="group flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-300 {{ $page === 'users' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/25' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 hover:shadow-md' }}">
